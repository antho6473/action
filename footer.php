<footer class="text-center text-lg-start bg-light text-muted">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                        ...
                        <h6 class="text-uppercase fw-bold mb-4">
                            <i class="fas fa-gem me-3"></i>ACTION CONTRE LA FAIM
                        </h6>
                        <p>
                        ...
                        <a class="nav-item nav-link" href="#">En savoir +</a>
                    </div>
                    <!-- Grid column -->
                    ...
                    <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                        ...
                        <p>
                            <a href="#!" class="text-reset">Nos évènements</a>
                        </p>
                    </div>
                    <!-- Grid column -->
                    ...
                    <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                        ...
                        <p><i class="fas fa-home me-3"></i>102 RUE DE PARIS, CS 10007, 93558 MONTREUIL CEDEX</p>
                        <p>
                            <i class="fas fa-envelope me-3"></i>
                            srd@actioncontrelafaim.org
                        </p>
                        <p><i class="fas fa-phone me-3"></i> +33 1 70 84 70 84</p>
                        <p><i class="fas fa-print me-3"></i> +33 1 70 84 70 70</p>
                    </div>
                    <!-- Grid column -->
                </div>
                <!-- Grid row -->
        ...
        <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05);">
            N° SIRET : 318 990 892 00065 - © Action contre la Faim 2023
            <a class="text-reset fw-bold" href="https://www.actioncontrelafaim.org/">Action contre la Faim</a>
        </div>
        <!-- Copyright -->
    </footer>